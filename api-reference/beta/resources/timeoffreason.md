...
|--------------|---------------|--------------------------------------------------------------------------------------------|
| code               | String                  | The code of the **timeOffReason** to represent an external identifier. This string can only contain alphanumeric characters, with max length of 100 characters, and requires to be unique within a Team. |
